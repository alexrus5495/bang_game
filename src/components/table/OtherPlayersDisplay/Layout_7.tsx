  ...
  return (
    ...
    >
      ...
      <div className="w-full h-[33%] flex justify-between">
        ...
        />
        <OtherPlayerPanel
          playerData={playersData[5].playerData}
          isCurrent={currentPlayerIndex === playersData[5].absoluteIndex}
        />
      </div>
      <div className="w-full h-[33%] flex justify-between">
        <OtherPlayerPanel
        ...
        />
        <OtherPlayerPanel
          playerData={playersData[6].playerData}
          isCurrent={currentPlayerIndex === playersData[6].absoluteIndex}
        />
      </div>
    </div>
  );
